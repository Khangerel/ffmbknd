...
class HTMXcategoryDeleteView(generic.DeleteView):
    model = models.category
    success_url = reverse_lazy("posts_category_htmx_list")
...
class HTMXpostDeleteView(generic.DeleteView):
    model = models.post
    success_url = reverse_lazy("posts_post_htmx_list")
...
class HTMXtagsListView(generic.ListView):
    model = models.tags
...
class HTMXtagsCreateView(generic.CreateView):
    model = models.tags
    form_class = forms.tagsForm
...
class HTMXtagsDeleteView(generic.DeleteView):
    model = models.tags
    success_url = reverse_lazy("posts_tags_htmx_list")
