...
class HTMXlanguageListView(generic.ListView):
...
class HTMXlanguageCreateView(generic.CreateView):
    model = models.language
    form_class = forms.languageForm
...
class HTMXlanguageDeleteView(generic.DeleteView):
    model = models.language
    success_url = reverse_lazy("languages_language_htmx_list")
