...
class HTMXinfoListView(generic.ListView):
    model = models.info
...
class HTMXinfoCreateView(generic.CreateView):
    model = models.info
    form_class = forms.infoForm
...
class HTMXinfoDeleteView(generic.DeleteView):
    model = models.info
    success_url = reverse_lazy("contact_info_htmx_list")
...
class HTMXattendeeListView(generic.ListView):
...
class HTMXattendeeCreateView(generic.CreateView):
    model = models.attendee
    form_class = forms.attendeeForm
...
class HTMXattendeeDeleteView(generic.DeleteView):
    model = models.attendee
    success_url = reverse_lazy("contact_attendee_htmx_list")
