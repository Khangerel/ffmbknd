...
function Home() {
  ...
  const getData = useCallback(async () => {
    ...
    const card_list_data = await API.get(
      `card/?lang_id=${localStorage.getItem("lang_id")}`
    );
    if (card_list_data.status === 200) {
      setLightCardList(card_list_data.data);
    }
    const recent_post_list_data = await API.get(
    ...
    <div>
      ...
      <div className="position-relative bg-hero-sm">
        <Container className="min-vh-100 d-flex align-items-center">
          <div>
            <h1
              className="hero-title blue-under-line pb-4 hero-blue-under-line sm-width-initial"
            ...
            <Row>
              <Col xl={6} lg={8} md={8} sm={12}>
                <p className="text-gray pt-4 swiper-slide__hero-content-hero__description">
            ...
            <div className="d-none-sm d-none-small-none d-none-md-none">
              <div className="d-flex  align-items-center pt-5 ">
                ...
                <div className="pe-5">
                  <h1>{lading.citizens}+</h1>
                  <p className="text-gray">{t("landing.citizens")}</p>
                </div>
                <div className="pe-5">
                  <h1>{lading.trainings}+</h1>
        ...
        >
          <HeroImage
            image1={lading.image_swipe1}
            image2={lading.image_swipe2}
            image3={lading.image_swipe3}
          />
        </div>
      </div>
          ...
          <Container className="w-100">
            <Row className="w-100 m-0 pt-5">
              <Col
                ...
                md={5}
                sm={12}
                className="bg-gradient-primary-white d-flex justify-content-center align-items-center mb-5"
              >
                <div className="pb-5 pt-5">
                  <h1 className="text-white hero-title pt-5 pb-5 text-center-sm">
                    Who <br /> We Are
                  </h1>
                  <div className="d-block d-xl-none d-lg-none pb-4">
                    <h1 className="text-white text-center pb-3">
                      {t("landing.whoweare_title")}
                    </h1>
              ...
              <Col
                ...
                md={7}
                sm={12}
                className="d-flex align-items-center mb-5  d-none-sm d-none-small-none d-none-md-none"
              >
                <div className="ps-5 pe-5 mx-5 d-none-sm d-none-small-none d-none-md-none">
                  <h4>{t("landing.whoweare_title")}</h4>
                  <p
                    className="pe-2 pt-2 text-black text-align-justify "
                    style={{
                      lineHeight: 2,
                    }}
                  >
          ...
          <Container className="pt-5 pb-5 mt-5">
            <div className="d-none-sm d-none-small-none d-none-md-none">
              <div className="d-flex bd-highlight pb-5">
                ...
                <p
                  className="text-gray ms-auto align-items-center d-flex"
                  dangerouslySetInnerHTML={{
                    __html: t("landing.whatwedo_description"),
                  }}
                ></p>
              </div>
            </div>
            <div className="d-block d-xl-none d-lg-none">
              ...
              <p
                className="text-gray ms-auto text-center"
                dangerouslySetInnerHTML={{
                  __html: t("landing.whatwedo_description"),
                }}
              ></p>
            ...
            <Row className="pt-5 mb-5 pb-5 px-4 mx-4">
              {light_card_list.map((card, index) => (
                ...
                >
                  <Card
                    className={`border-none position-relative rounded-15 w-100`}
                    style={{
            ...
            <Row className="w-100 pb-5 m-0">
              {recent_post_list.length > 0 ? (
                <Col xl={5} lg={5} sm={12} md={12} className="pe-4 mb-5">
                  <div
                    className="p-4 min-vh-50 h-100 position-relative "
                    style={{
                  ...
                  >
                    {recent_post_list[0].tags.map((el, index) => (
                      <Button
                        className="px-4 pt-1 pb-1 bg-prime-weak border-none font-weight-bold"
                        key={index}
                      >
                        {el.name}
                      </Button>
                    ...
                    >
                      <Link
                        className="text-white me-4 text-bold"
                        to={`/news/${recent_post_list[0].id}`}
                      >
