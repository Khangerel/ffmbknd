import { Button, Col, Row, Image, ListGroup, Container } from "react-bootstrap";
              ...
              <Row>
                <Col lg={8}>
                  <div className="d-flex mb-5 mt-5">
                    ...
                    <p className="text-gray ms-auto">
                      {news_data.publish_date_formatted}
                    </p>
                  </div>
                </Col>
                <Col lg={4}></Col>
              ...
              <Row className="mb-5 pb-5">
                <Col lg={8}>
                  <div className="pe-5">
                    ...
                    <div
                      dangerouslySetInnerHTML={{ __html: news_data.content }}
                      className="text-align-justify"
                      style={{ fontSize: "16px !important", lineHeight: 2 }}
                    ></div>
                  </div>
                </Col>
                <Col lg={4}>
                    ...
                    <div>
                      ...
                      <ListGroup className="border-none mt-4">
                        {category_list.map((categ, index) => (
                          <ListGroup.Item
                            variant="light"
                            className="border-none mb-1 pb-1 pt-1 text-gray"
                          >
                            {categ.name}
                          </ListGroup.Item>
                        ))}
                      ...
                      <div className="mt-4">
                        {featured_card_list.map((el, index) => (
                          <div className="mb-3" key={index}>
                            ...
                            <p className="text-gray mt-3 text-align-justify">
                              {el.description}
                            </p>
                            <div className="d-flex justify-content-end">
                              <Link
                                className="text-dark me-4 text-bold"
                                to={`/news/${el.id}`}
                              >
