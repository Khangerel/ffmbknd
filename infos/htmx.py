...
class HTMXpartnerListView(generic.ListView):
...
class HTMXpartnerCreateView(generic.CreateView):
    model = models.partner
    form_class = forms.partnerForm
...
class HTMXpartnerDeleteView(generic.DeleteView):
    model = models.partner
    success_url = reverse_lazy("infos_partner_htmx_list")
...
class HTMXlandingListView(generic.ListView):
...
class HTMXlandingCreateView(generic.CreateView):
    model = models.landing
    form_class = forms.landingForm
...
class HTMXlandingDeleteView(generic.DeleteView):
    model = models.landing
    success_url = reverse_lazy("infos_landing_htmx_list")
